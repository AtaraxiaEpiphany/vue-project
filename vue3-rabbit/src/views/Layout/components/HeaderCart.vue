...
const { cartList } = storeToRefs(cartStroe)
...
<template>
    <div class="cart">
        ...
        <div class="layer">
            <div class="list">
                <div class="item" v-for="i in cartList" :key="cartList.skuId">
                    <RouterLink to="">
                    ...
                    <i class="iconfont icon-close-new" @click="cartStroe.deleteCart(i.skuId)"></i>
                </div>
            </div>
            <div class="foot">
                <div class="total">
