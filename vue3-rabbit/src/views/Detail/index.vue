...
const getGoods = async () => {
    const resp = await getDetail(route.params.id)
    goods.value = resp.result
}

const skuChange = (sku) => {
    console.log(`Change sku ==> `, sku)
}
    ...
    <div class="xtx-goods-page">
        <div class="container" v-if="goods.categories">
            <div class="bread-container">
                <!-- 简单使用goods.categories[1].id等会报错, -->
                <!-- 初始goods={},{}.categories[1] 相当于undefined[1],会报错-->
                <!-- 1.使用v-if 同一控制显示 -->
                <!-- 2.使用可选链Optional Chaining (?.) -->
